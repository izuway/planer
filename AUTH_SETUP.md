...
4. После успешной регистрации вы будете автоматически залогинены
5. Проверьте localStorage - там должен быть `firebase_token`
6. Попробуйте выйти через drawer menu
7. Попробуйте снова войти с теми же credentials
